$(document).ready(function(){
  ...
  // cliccando su fa-angle-double-up scrollo la pagina da dove mi trovo fino a su in 2 sec
  ...
  function ricercaTitolo(){
    ...
    // per collegare la scelta della categoria ai risultati che vedo in pagina (if else)
    // se non seleziono nulla (prima scelta) stampo sia Film che tv
    if ($(".scegli-genere").val() == ""){
      ...
      // se scelgo film vedrò in pagina solo i Film
    }else if ($(".scegli-genere").val() == "film") {

      // funzione chiamata ajax per film
      chiamataAjax(linkFilm, apiKeyMio, valoreInput, "film");

      // se scelgo tv vedrò in pagina solo le serie tv
    }else if ($(".scegli-genere").val() == "tv") {
